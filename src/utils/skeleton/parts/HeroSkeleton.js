export const HeroSkeleton = () => {
  return (
    <div
      className='opacity-60 animate-pulse w-full h-[50vh] relative overflow-hidden mx-auto flex flex-col md:flex-row items-center py-12 md:py-24 mb-10 bg-gray-700 dark:bg-gray-700'
    >
